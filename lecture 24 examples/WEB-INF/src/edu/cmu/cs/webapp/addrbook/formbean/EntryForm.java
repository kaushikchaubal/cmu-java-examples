...
public class EntryForm extends IdForm {
    ...
    private NMSQLDate birthdayDate       = null;
    private NMSQLDate spouseBirthdayDate = null;
    ...
    public NMSQLDate getBirthdayAsDate()       { return birthdayDate;       }
    public NMSQLDate getSpouseBirthdayAsDate() { return spouseBirthdayDate; }
	...
	public List<String> getValidationErrors() {
		...
		try {
			if (birthday.length() > 0) {
				...
				birthdayDate = new NMSQLDate(d.getTime());
			}
		...
		try {
			if (spouseBirthday.length() > 0) {
				...
				spouseBirthdayDate = new NMSQLDate(d.getTime());
			}
		} catch (ParseException e) {
